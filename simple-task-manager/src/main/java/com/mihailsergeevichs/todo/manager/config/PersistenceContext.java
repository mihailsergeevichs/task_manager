...
@EnableJpaRepositories(basePackages = {
        "com.mihailsergeevichs.todo.manager.user.repository",
})
@EnableTransactionManagement
public class PersistenceContext {

    private static final String[] PROPERTY_PACKAGES_TO_SCAN = {
            "com.mihailsergeevichs.task.manager.common.model",
            "com.mihailsergeevichs.task.manager.user.model",
            "com.mihailsergeevichs.task.manager.task.model"
    };
